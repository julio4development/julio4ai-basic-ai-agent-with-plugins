...
st.set_page_config(
    page_title="""
    Basic AI Agent that decides what plugins to use
    in order to solve your request
    """
)

st.title("Basic AI Agent that decides what plugins to use in order to solve your request")
...
query_text = st.text_input(
    ...
    placeholder="Example: What shirts can I buy?")
